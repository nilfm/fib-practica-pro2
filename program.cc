...
int main(){
    ...
    while (cont) {
        ...
        if (opcion == "escribir") {
            ...
            else cout << alm.consultar_sala(sala).poner_items(id, quant, inv) << endl;
        }
            ...
            else cout << alm.consultar_sala(sala).quitar_items(id, quant, inv) << endl;
        }
            ...
            else cout << alm.consultar_sala(sala).consultar_pos(fila, columna) << endl;
        }
